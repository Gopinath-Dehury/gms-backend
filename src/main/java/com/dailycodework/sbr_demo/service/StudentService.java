...
import com.dailycodework.sbr_demo.exception.StudentAlreadyExistsException;
import com.dailycodework.sbr_demo.exception.StudentNotFoundException;
import com.dailycodework.sbr_demo.model.Student;
import com.dailycodework.sbr_demo.repository.StudentRepository;
...
public class StudentService implements IStudentService{
    ...
    public Student updateStudent(Student student, Long id) {
        ...
        }).orElseThrow(() -> new StudentNotFoundException("Sorry, this Student ID "+id+" could not be found"));
    }
